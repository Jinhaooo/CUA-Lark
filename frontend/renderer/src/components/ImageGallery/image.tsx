...
export const SnapshotImage: React.FC<ImageProps> = (props) => {
  ...
  return (
    <div className="max-w-full h-[calc(100vh-280px)] flex items-center justify-center relative bg-white rounded-lg overflow-hidden">
      <img
        ref={imgRef}
        src={src}
        className="block object-contain max-h-full select-none bg-white"
        alt={alt}
      />
      {/* <button
