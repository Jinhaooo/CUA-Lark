  ...
  return (
    <>
      {step.action_type && (
        <Button
          variant="outline"
          className="mb-4 h-8 rounded-full px-2.5 text-[13px]"
          size="sm"
          onClick={onClick}
        ...
        >
          ...
          {step.action_type === 'call_user' ? (
            ...
            <>
              动作：
              <span className="max-w-44 truncate text-[13px] text-gray-600">
                {step.action_type}
...
export default function ThoughtChain({
  ...
  return (
    <div>
      {reflectionStep && (
        <div className="my-2 text-[13px] leading-5 text-gray-600">
