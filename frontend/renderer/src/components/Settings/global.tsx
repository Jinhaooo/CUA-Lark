...
import { PermissionSettings } from './category/permissions';
          ...
          <div className="flex-1">
            <TabsContent value="vlm" className="mt-0">
              <ScrollArea className="h-[calc(80vh-48px)]">
                <h2 className="text-xl font-semibold mb-3">视觉大模型设置</h2>
            ...
            <TabsContent value="operator" className="mt-0 flex-1">
              <ScrollArea className="h-[calc(80vh-48px)]">
                <h2 className="text-xl font-semibold mb-3">本地运行设置</h2>
                <Separator className="mb-4" />
                <h3 className="text-lg font-semibold mt-5 mb-3">本地浏览器</h3>
                <LocalBrowserSettings />
              </ScrollArea>
            </TabsContent>
            <TabsContent value="permissions" className="mt-0">
              <ScrollArea className="h-[calc(80vh-48px)]">
                <h2 className="text-xl font-semibold mb-3">权限配置</h2>
                <Separator className="mb-4" />
                <PermissionSettings />
              </ScrollArea>
            </TabsContent>
