...
import { SkillLibraryDialog } from '../Skills/SkillLibraryDialog';
...
import { api } from '../../api';
import { setCuaEntryMode } from '@renderer/utils/cuaEntry';
      ...
      <Sidebar collapsible="icon" className="select-none" {...props}>
        ...
        <SidebarFooter className="p-0">
          <NavSettings
            ...
            onSkillClick={() => setSkillLibraryOpen(true)}
          />
        </SidebarFooter>
      </Sidebar>
      <GlobalSettings />
      <SkillLibraryDialog
        open={isSkillLibraryOpen}
